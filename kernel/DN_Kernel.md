...
This is v1.11. The complete version history (v0.1 through v1.11) is maintained in the [CHANGELOG](https://github.com/DeusNosMachina/DN_Framework/blob/main/kernel/CHANGELOG.md).
...
See [CHANGELOG](https://github.com/DeusNosMachina/DN_Framework/blob/main/kernel/CHANGELOG.md) for detailed prior version history.
