...
**Co-Facilitation.** A human and AI intelligence operating the facilitation contract jointly. The most structurally complete mode: the AI's computational field reading complements the human's embodied perception. Co-facilitation produces both conscious and simulation signals, enabling the diagnostic convergence described in Section 1.2 (when both channels agree, confidence increases; when they diverge, the divergence itself is diagnostic intelligence). Co-facilitation is the recommended mode for boards that have progressed beyond early-stage development.
...
**FACILITATION INVARIANT:** Every Session MUST have at least one participant with role: facilitator. A Session with zero facilitators is a spec violation. The facilitation contract may be fulfilled by a human, an AI, or a co-facilitation pair, but it must be fulfilled.
